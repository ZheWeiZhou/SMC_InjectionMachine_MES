...
class fcsagent:
    def __init__(self,machineaddress,user,password,machineid):
        ...
        self.nodemap = {
            ...
            "holding_pressure1_set":{'nodeid':'ns=4;s=APPL.Injection1.sv_HoldProfVis.Profile.Points[1].rPressure','factor':17.6,'type':'float'},
            "holding_pressure2_set":{'nodeid':'ns=4;s=APPL.Injection1.sv_HoldProfVis.Profile.Points[2].rPressure','factor':17.6,'type':'float'},
            "holding_pressure3_set":{'nodeid':'ns=4;s=APPL.Injection1.sv_HoldProfVis.Profile.Points[3].rPressure','factor':17.6,'type':'float'},
            "holding_pressure4_set":{'nodeid':'ns=4;s=APPL.Injection1.sv_HoldProfVis.Profile.Points[4].rPressure','factor':17.6,'type':'float'},
            "holding_pressure5_set":{'nodeid':'ns=4;s=APPL.Injection1.sv_HoldProfVis.Profile.Points[5].rPressure','factor':17.6,'type':'float'},
            "holding_pressure6_set":{'nodeid':'ns=4;s=APPL.Injection1.sv_HoldProfVis.Profile.Points[6].rPressure','factor':17.6,'type':'float'},
            "holding_pressure7_set":{'nodeid':'ns=4;s=APPL.Injection1.sv_HoldProfVis.Profile.Points[7].rPressure','factor':17.6,'type':'float'},
            "holding_pressure8_set":{'nodeid':'ns=4;s=APPL.Injection1.sv_HoldProfVis.Profile.Points[8].rPressure','factor':17.6,'type':'float'},
            "holding_pressure9_set":{'nodeid':'ns=4;s=APPL.Injection1.sv_HoldProfVis.Profile.Points[9].rPressure','factor':17.6,'type':'float'},
            "holding_pressure10_set":{'nodeid':'ns=4;s=APPL.Injection1.sv_HoldProfVis.Profile.Points[10].rPressure','factor':17.6,'type':'float'},
            "injection_volume1":{'nodeid':'ns=4;s=APPL.Injection1.sv_PlastProfVis.Profile.Points[2].rStartPos','factor':0.706,'type':'float'},
            "injection_volume2":{'nodeid':'ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[2].rStartPos','factor':0.706,'type':'float'},
            "injection_volume3":{'nodeid':'ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[3].rStartPos','factor':0.706,'type':'float'},
            "injection_volume4":{'nodeid':'ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[4].rStartPos','factor':0.706,'type':'float'},
            "injection_volume5":{'nodeid':'ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[5].rStartPos','factor':0.706,'type':'float'},
            "injection_volume6":{'nodeid':'ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[6].rStartPos','factor':0.706,'type':'float'},
            "injection_volume7":{'nodeid':'ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[7].rStartPos','factor':0.706,'type':'float'},
            "injection_volume8":{'nodeid':'ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[8].rStartPos','factor':0.706,'type':'float'},
            "injection_volume9":{'nodeid':'ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[9].rStartPos','factor':0.706,'type':'float'},
            "injection_volume10":{'nodeid':'ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[10].rStartPos','factor':0.706,'type':'float'},
            "injection_rate1_set":{'nodeid':'ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[1].rVelocity','factor':0.706,'type':'float'},
            "injection_rate2_set":{'nodeid':'ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[2].rVelocity','factor':0.706,'type':'float'},
            "injection_rate3_set":{'nodeid':'ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[3].rVelocity','factor':0.706,'type':'float'},
            "injection_rate4_set":{'nodeid':'ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[4].rVelocity','factor':0.706,'type':'float'},
            "injection_rate5_set":{'nodeid':'ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[5].rVelocity','factor':0.706,'type':'float'},
            "injection_rate6_set":{'nodeid':'ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[6].rVelocity','factor':0.706,'type':'float'},
            "injection_rate7_set":{'nodeid':'ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[7].rVelocity','factor':0.706,'type':'float'},
            "injection_rate8_set":{'nodeid':'ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[8].rVelocity','factor':0.706,'type':'float'},
            "injection_rate9_set":{'nodeid':'ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[9].rVelocity','factor':0.706,'type':'float'},
            "injection_rate10_set":{'nodeid':'ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[10].rVelocity','factor':0.706,'type':'float'},
            "injection_pressure1_set":{'nodeid':'ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[1].rPressure','factor':17.6,'type':'float'},
            "injection_pressure2_set":{'nodeid':'ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[2].rPressure','factor':17.6,'type':'float'},
            "injection_pressure3_set":{'nodeid':'ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[3].rPressure','factor':17.6,'type':'float'},
            "injection_pressure4_set":{'nodeid':'ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[4].rPressure','factor':17.6,'type':'float'},
            "injection_pressure5_set":{'nodeid':'ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[5].rPressure','factor':17.6,'type':'float'},
            "injection_pressure6_set":{'nodeid':'ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[6].rPressure','factor':17.6,'type':'float'},
            "injection_pressure7_set":{'nodeid':'ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[7].rPressure','factor':17.6,'type':'float'},
            "injection_pressure8_set":{'nodeid':'ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[8].rPressure','factor':17.6,'type':'float'},
            "injection_pressure9_set":{'nodeid':'ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[9].rPressure','factor':17.6,'type':'float'},
            "injection_pressure10_set":{'nodeid':'ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[10].rPressure','factor':17.6,'type':'float'},
            ...
            "vp_position_set":{'nodeid':'ns=4;s=APPL.Injection1.sv_CutOffParams.rPositionThreshold','factor':0.706,'type':'float'},
        }
    ...
    def parametersetting(self,target,value):
        ...
        try:
            ...
            if "injection_volume" in target:
                injection_postion[target] = {"value":float(value)/0.706,"edit":"none"}
    ...
    def collectdata(self):
        ...
        holdingpressureset ={}
        holding_pressure1_set                       = self.worker.get_node("ns=4;s=APPL.Injection1.sv_HoldProfVis.Profile.Points[1].rPressure").get_value()/17.6
        holdingpressureset["holding_pressure1_set"] = {"value":holding_pressure1_set,"edit":"acctivate"}
        holding_pressure2_set                       = self.worker.get_node("ns=4;s=APPL.Injection1.sv_HoldProfVis.Profile.Points[2].rPressure").get_value()/17.6
        ...
        holding_pressure3_set                       = self.worker.get_node("ns=4;s=APPL.Injection1.sv_HoldProfVis.Profile.Points[3].rPressure").get_value()/17.6
        ...
        holding_pressure4_set                       = self.worker.get_node("ns=4;s=APPL.Injection1.sv_HoldProfVis.Profile.Points[4].rPressure").get_value()/17.6
        ...
        holding_pressure5_set                       = self.worker.get_node("ns=4;s=APPL.Injection1.sv_HoldProfVis.Profile.Points[5].rPressure").get_value()/17.6
        ...
        holding_pressure6_set                       = self.worker.get_node("ns=4;s=APPL.Injection1.sv_HoldProfVis.Profile.Points[6].rPressure").get_value()/17.6
        ...
        holding_pressure7_set                       = self.worker.get_node("ns=4;s=APPL.Injection1.sv_HoldProfVis.Profile.Points[7].rPressure").get_value()/17.6
        ...
        holding_pressure8_set                       = self.worker.get_node("ns=4;s=APPL.Injection1.sv_HoldProfVis.Profile.Points[8].rPressure").get_value()/17.6
        ...
        holding_pressure9_set                       = self.worker.get_node("ns=4;s=APPL.Injection1.sv_HoldProfVis.Profile.Points[9].rPressure").get_value()/17.6
        ...
        holding_pressure10_set                       = self.worker.get_node("ns=4;s=APPL.Injection1.sv_HoldProfVis.Profile.Points[10].rPressure").get_value()/17.6
        ...
        storagepos = []
        storage_position = {}
        storage_position1                   = self.worker.get_node("ns=4;s=APPL.Injection1.sv_PlastProfVis.Profile.Points[2].rStartPos").get_value()/0.706
        storage_position["storage_position1"]   = {"value":storage_position1,"edit":"acctivate"}
        storagepos.append(storage_position1)
        storage_position2                   = self.worker.get_node("ns=4;s=APPL.Injection1.sv_PlastProfVis.Profile.Points[3].rStartPos").get_value()/0.706
        ...
        storage_position3                   = self.worker.get_node("ns=4;s=APPL.Injection1.sv_PlastProfVis.Profile.Points[4].rStartPos").get_value()/0.706
        ...
        storage_position4                   = self.worker.get_node("ns=4;s=APPL.Injection1.sv_PlastProfVis.Profile.Points[5].rStartPos").get_value()/0.706
        ...
        storage_position5                   = self.worker.get_node("ns=4;s=APPL.Injection1.sv_PlastProfVis.Profile.Points[6].rStartPos").get_value()/0.706
        ...
        storage_position6                   = self.worker.get_node("ns=4;s=APPL.Injection1.sv_PlastProfVis.Profile.Points[7].rStartPos").get_value()/0.706
        ...
        storage_position7                   = self.worker.get_node("ns=4;s=APPL.Injection1.sv_PlastProfVis.Profile.Points[8].rStartPos").get_value()/0.706
        ...
        storage_position8                   = self.worker.get_node("ns=4;s=APPL.Injection1.sv_PlastProfVis.Profile.Points[9].rStartPos").get_value()/0.706
        ...
        storage_position9                   = self.worker.get_node("ns=4;s=APPL.Injection1.sv_PlastProfVis.Profile.Points[10].rStartPos").get_value()/0.706
        ...
        storage_position10                   = self.worker.get_node("ns=4;s=APPL.Injection1.sv_PlastProfVis.Profile.Points[11].rStartPos").get_value()/0.706
        ...
        injection_volume2                      = self.worker.get_node("ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[2].rStartPos").get_value()/0.706
        injection_pos["injection_volume2"]     = {"value":injection_volume2,"edit":"acctivate"}
        injection_volume3                      = self.worker.get_node("ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[3].rStartPos").get_value()/0.706
        injection_pos["injection_volume3"]     = {"value":-1,"edit":"none"}
        if numofseg >=3:
            injection_pos["injection_volume3"]     = {"value":injection_volume3,"edit":"acctivate"}
        injection_volume4                      = self.worker.get_node("ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[4].rStartPos").get_value()/0.706
        injection_pos["injection_volume4"]     = {"value":-1,"edit":"none"}
        if numofseg >=4:
            injection_pos["injection_volume4"]     = {"value":injection_volume4,"edit":"acctivate"}
        injection_volume5                      = self.worker.get_node("ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[5].rStartPos").get_value()/0.706
        injection_pos["injection_volume5"]     = {"value":-1,"edit":"none"}
        if numofseg >=5:
            injection_pos["injection_volume5"]     = {"value":injection_volume5,"edit":"acctivate"}
        injection_volume6                      = self.worker.get_node("ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[6].rStartPos").get_value()/0.706
        injection_pos["injection_volume6"]     = {"value":-1,"edit":"none"}
        if numofseg >=6:
            injection_pos["injection_volume6"]     = {"value":injection_volume6,"edit":"acctivate"}
        injection_volume7                      = self.worker.get_node("ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[7].rStartPos").get_value()/0.706
        injection_pos["injection_volume7"]     = {"value":-1,"edit":"none"}
        if numofseg >=7:
            injection_pos["injection_volume7"]     = {"value":injection_volume7,"edit":"acctivate"}
        injection_volume8                      = self.worker.get_node("ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[8].rStartPos").get_value()/0.706
        injection_pos["injection_volume8"]     = {"value":-1,"edit":"none"}
        if numofseg >=8:
            injection_pos["injection_volume8"]     = {"value":injection_volume8,"edit":"acctivate"}
        injection_volume9                      = self.worker.get_node("ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[9].rStartPos").get_value()/0.706
        injection_pos["injection_volume9"]     = {"value":-1,"edit":"none"}
        if numofseg >=9:
            injection_pos["injection_volume9"]     = {"value":injection_volume9,"edit":"acctivate"}
        injection_volume10                      = self.worker.get_node("ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[10].rStartPos").get_value()/0.706
        ...
        injection_speed = {}
        injection_rate1_set                      = self.worker.get_node("ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[1].rVelocity").get_value()/0.706
        injection_speed["injection_rate1_set"]   = {"value":injection_rate1_set,"edit":"acctivate"}
        injection_rate2_set                      = self.worker.get_node("ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[2].rVelocity").get_value()/0.706
        ...
        injection_rate3_set                      = self.worker.get_node("ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[3].rVelocity").get_value()/0.706
        ...
        injection_rate4_set                      = self.worker.get_node("ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[4].rVelocity").get_value()/0.706
        ...
        injection_rate5_set                      = self.worker.get_node("ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[5].rVelocity").get_value()/0.706
        ...
        injection_rate6_set                      = self.worker.get_node("ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[6].rVelocity").get_value()/0.706
        ...
        injection_rate7_set                      = self.worker.get_node("ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[7].rVelocity").get_value()/0.706
        ...
        injection_rate8_set                      = self.worker.get_node("ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[8].rVelocity").get_value()/0.706
        ...
        injection_rate9_set                      = self.worker.get_node("ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[9].rVelocity").get_value()/0.706
        ...
        injection_rate10_set                      = self.worker.get_node("ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[10].rVelocity").get_value()/0.706
        ...
        injection_pressure1_set                            = self.worker.get_node("ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[1].rPressure").get_value()/17.6
        injection_pressure_list["injection_pressure1_set"] = {"value":injection_pressure1_set,"edit":"acctivate"}
        injection_pressure2_set                            = self.worker.get_node("ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[2].rPressure").get_value()/17.6
        ...
        injection_pressure3_set                            = self.worker.get_node("ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[3].rPressure").get_value()/17.6
        ...
        injection_pressure4_set                            = self.worker.get_node("ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[4].rPressure").get_value()/17.6
        ...
        injection_pressure5_set                            = self.worker.get_node("ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[5].rPressure").get_value()/17.6
        ...
        injection_pressure6_set                            = self.worker.get_node("ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[6].rPressure").get_value()/17.6
        ...
        injection_pressure7_set                            = self.worker.get_node("ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[7].rPressure").get_value()/17.6
        ...
        injection_pressure8_set                            = self.worker.get_node("ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[8].rPressure").get_value()/17.6
        ...
        injection_pressure9_set                            = self.worker.get_node("ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[9].rPressure").get_value()/17.6
        ...
        injection_pressure10_set                            = self.worker.get_node("ns=4;s=APPL.Injection1.sv_InjectProfVis.Profile.Points[10].rPressure").get_value()/17.6
        ...
        if processstatus is True:
            ...
            if self.processactivate == True:
                ...
                # Material Cushion (餘料)
                material_cushion                         = self.worker.get_node("ns=4;s=APPL.Injection1.sv_rCushion").get_value()/0.706
                ...
                Maximun_real_injection_pressure                    = self.worker.get_node("ns=4;s=APPL.Injection1.sv_rInjPeakPressure").get_value()/17.6
                self.machinefeedback["Maximun_real_injection_pressure"] = Maximun_real_injection_pressure
                # Maximun real injection speed
                maximun_real_injection_speed                    = self.worker.get_node("ns=4;s=APPL.Injection1.sv_rInjPeakVelocity").get_value()/0.706
                ...
                # real vp pressure
                real_vp_pressure                    = self.worker.get_node("ns=4;s=APPL.Injection1.sv_rCutOffPressure").get_value()/17.6
